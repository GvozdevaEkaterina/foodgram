    ...
    <Container>
      ...
      <div className={styles.content}>
        ...
        <aside>
          ...
          <div className={styles.text}>
            <p className={styles.textItem}>
              Код проекта находится тут - <a href="https://github.com/GvozdevaEkaterina/foodgram/" className={styles.textLink}>Github</a>
            </p>
            <p className={styles.textItem}>
              Автор проекта: <a href="https://www.linkedin.com/in/ekaterina-gvozdeva-40a5761a9" className={styles.textLink}>Екатерина Гвоздева</a>
            </p>
          </div>
        </aside>
      </div>
